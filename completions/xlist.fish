set -l commands sheets headers uniques select help
set -l actions sheets headers uniques select

function __fish_xlist_contains_sheets
    set -l cmd_args (commandline -opc)
    set -l contains n
    set -l list_arr headers uniques select
...
complete -c xlist -n "not __fish_seen_subcommand_from $commands" -a select -d "Print all values for the given columns"
...
# xlist select
complete -c xlist -n "__fish_seen_subcommand_from select; and not __fish_seen_subcommand_from help; and __fish_is_nth_token 3" -ka '(__fish_xlist_complete_sheets)'
complete -c xlist -n "__fish_seen_subcommand_from select; and not __fish_seen_subcommand_from help; and not __fish_is_nth_token 3; and not __fish_is_nth_token 2" -ka '(__fish_xlist_complete_headers)'
